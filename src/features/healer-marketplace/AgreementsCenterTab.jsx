      ...
      <div className="grid md:grid-cols-2 gap-4">
        ...
        <div className="p-5 rounded-2xl border border-amber-500/20 bg-stone-900/60 backdrop-blur-md space-y-3">
          ...
          <div className="pt-2 border-t border-white/5 flex items-center justify-between text-xs text-stone-300">
            <span>Platform Commission: <strong className="text-amber-300">15% on sessions</strong></span>
        ...
        <div className="divide-y divide-white/5">
          <div className="py-3 flex items-center justify-between text-xs">
            <div className="flex items-center gap-3">
              ...
              <div>
                <p className="font-medium text-stone-200">Independent Energy Practitioner Agreement (v2026.1)</p>
                <p className="text-stone-500 text-[11px]">Signed on {new Date().toLocaleDateString()} | Verified SHA-256</p>
              </div>
            </div>
          ...
          <div className="py-3 flex items-center justify-between text-xs">
            <div className="flex items-center gap-3">
              <FileCheck className="w-4 h-4 text-emerald-400" />
              <div>
                <p className="font-medium text-stone-200">Sanctuary Healer Code of Ethics & Non-Medical Boundaries (v2026.1)</p>
                <p className="text-stone-500 text-[11px]">Signed on {new Date().toLocaleDateString()} | Safe Harbor Verified</p>
              </div>
            </div>
            <button className="px-3 py-1 rounded bg-stone-800 hover:bg-stone-700 text-stone-300 flex items-center gap-1">
              <Download className="w-3 h-3" /> PDF
          ...
          <div className="py-3 flex items-center justify-between text-xs">
            <div className="flex items-center gap-3">
              <FileCheck className="w-4 h-4 text-emerald-400" />
              <div>
                <p className="font-medium text-stone-200">Form W-9 Taxpayer Responsibility & Payout Acknowledgment</p>
                <p className="text-stone-500 text-[11px]">Signed electronically via Stripe Express</p>
              </div>
            </div>
            <button className="px-3 py-1 rounded bg-stone-800 hover:bg-stone-700 text-stone-300 flex items-center gap-1">

...
const AdvocatesTab = () => {
  const advocates = [
    { name: 'Dr. Mehmet Oz', role: 'Cardiothoracic Surgeon & TV Host', category: 'Medical & Science', note: 'Prominently featured Reiki on his television program and invited Reiki Master Pamela Miles into the operating room at Columbia University Medical Center, referring to it as "my favorite treatment in the entire operating room" to stabilize heart patients.' },
    { name: 'Erykah Badu', role: 'Grammy-Winning Artist & Certified Reiki Master', category: 'Music & Arts', note: 'A dedicated, certified Usui Reiki Master and holistic practitioner who actively performs energy healing on herself, band members, and collaborators to cultivate creative grounding and balance.' },
    { name: 'Gwyneth Paltrow', role: 'Oscar-Winning Actress & Goop Founder', category: 'Film & Wellness', note: 'Openly credits regular Reiki energy sessions with helping her navigate acute grief, emotional divorce transitions, and grounding. Frequently features credentialed Reiki masters across her global Goop platform.' },
    { name: 'Angelina Jolie', role: 'Oscar-Winning Actress & Humanitarian', category: 'Film & Humanitarian', note: 'Longtime practitioner of daily meditation and Reiki energy work to decompress from intense international humanitarian missions, action film sets, and demanding schedules.' },
    { name: 'Lili Reinhart', role: 'Actress (Riverdale) & Certified Reiki Master', category: 'Film & Arts', note: 'Underwent extensive master-level apprenticeships to earn certification as an authentic Reiki practitioner, sharing openly with Gen-Z audiences how biofield work alleviates severe anxiety.' },
    { name: 'Christina Aguilera', role: 'Grammy-Winning Pop Icon', category: 'Music & Performance', note: 'Publicly revealed she turned to regular Reiki energy balancing, yoga, and mindful nutrition to maintain emotional equilibrium and vocal clarity while coping with high-stress world tours.' },
    { name: 'Nicole Kidman', role: 'Academy & Emmy Award-Winning Actress', category: 'Film & Arts', note: 'Has shared how gentle Reiki biofield therapy provides deep restorative calm, mental clarity, and nervous system balance during rigorous filming schedules.' },
    { name: 'Phil Mickelson', role: '6-Time Major Champion PGA Golfer', category: 'Athletics & Sports', note: 'Incorporated sports Reiki energy therapy into his athletic regimen to manage tournament psychological pressure and alleviate joint inflammation associated with psoriatic arthritis.' },
    { name: 'Donna Karan', role: 'Fashion Icon & Urban Zen Founder', category: 'Design & Healthcare', note: 'Established the landmark Urban Zen Integrative Therapy (UZIT) Foundation, embedding certified Reiki masters directly into cancer wards and emergency trauma centers across Beth Israel and UCLA.' },
    { name: 'Shania Twain', role: 'Global Music Icon & Author', category: 'Music & Performance', note: 'Featured a full sacred Reiki session on her docuseries "Why Not? With Shania Twain," documenting how energy healing helped her restore emotional confidence and heal vocal chord dysphonia.' },
    { name: 'Madonna', role: 'Queen of Pop & Cultural Pioneer', category: 'Music & Performance', note: 'Embraces Usui Reiki rituals as a staple of her metaphysical wellness discipline, utilizing energy harmonizations before arena performances to sustain stamina and spiritual focus.' },
    { name: 'Oprah Winfrey', role: 'Global Media Pioneer & Philanthropist', category: 'Media & Literature', note: 'Has highlighted energy medicine and Reiki pioneers on SuperSoul Sunday and O Magazine, normalizing biofield energy modalities for hundreds of millions of households worldwide.' },
    { name: 'Cameron Diaz', role: 'Actress & Bestselling Author', category: 'Film & Wellness', note: 'Dedicated advocate of holistic health and Chinese medicine who incorporates energy work and Reiki to promote longevity, nervous system restoration, and vitality.' },
    { name: 'Sandra Bullock', role: 'Academy Award-Winning Actress', category: 'Film & Arts', note: 'Frequently incorporates private energy clearing and Reiki sessions between major film productions to maintain equilibrium and vibrant personal presence.' },
    { name: 'Hema Malini', role: 'Legendary Indian Cinema Icon & Parliamentarian', category: 'International Cinema', note: 'An initiated Reiki master who has practiced energy attunements for over 25 years, utilizing daily Reiki healing before major classical dance recitals and film productions.' },
    { name: 'Anil Kapoor', role: 'International Actor (Slumdog Millionaire)', category: 'International Cinema', note: 'Publicly credits energy healing and Reiki with calming intense anxiety and panic before emotionally taxing scenes, maintaining a calm center throughout a four-decade career.' },
    { name: 'Sting & Trudie Styler', role: 'Musical Icon & Film Producer', category: 'Music & Wellness', note: 'Devout practitioners of holistic spiritual sciences who receive regular Reiki attunements and sound resonance therapy to support mindful living and musical composition.' },
    { name: 'Kate Hudson', role: 'Actress & Fabletics Founder', category: 'Film & Fitness', note: 'Lifelong proponent of vibrational medicine and crystal healing who champions Reiki as an essential tool for mothering balance and creative stamina.' }
  ];
  return (
    <>
      <section className="science-section">

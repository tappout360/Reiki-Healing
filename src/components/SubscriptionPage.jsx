...
const SubscriptionPage = ({ onClose, onUpgrade }) => {
  ...
  const faqs = [
    ...
    { q: "Is this HIPAA compliant?", a: "Absolutey. We do not store medical data. Our questionnaires assess energy fields and vibrational alignment, which are protected under spiritual practice laws." },

...
const HealerApplicationModal = ({ user, onClose }) => {
  ...
  const handleSubmit = (e) => {
    ...
    const newApplication = {
      ...
      password: formData.password, // This will be used to create the account upon approval
    ...
    localStorage.setItem('aura_applications', JSON.stringify([...applications, newApplication]));
